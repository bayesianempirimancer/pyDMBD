...
print('Initializing X + V model....')
model = DMBD(obs_shape=data.shape[-2:],role_dims=(8,2,2),hidden_dims=(4,2,2),regression_dim = -1, control_dim = 0, number_of_objects=8, unique_obs=False)

print('Updating model X+V....')
model.update(data,None,None,iters=50,latent_iters=5,lr=0.5)
#model.px = None
model.update(data,None,None,iters=10,latent_iters=1,lr=0.5)
#model.update(data,None,None,iters=10,latent_iters=1,lr=1)
print('Making Movie')
